/**
 * EmailDialogueChoice Component
 * Type B — Email inline rendering
 * 
 * Renders inside the Outbox reading pane, below the email body, 
 * replacing the standard Reply/Archive buttons while active.
 */
...
export const EmailDialogueChoice: React.FC<EmailDialogueChoiceProps> = ({
  ...
  const handleSelect = useCallback((optionId: string) => {
    ...
    const resolved: ResolvedChoice = {
      ...
      context: `Email: ${emailSubject} — ${choice.id}`
    };
  ...
  return (
    <div className="dialogue-choice-container dialogue-outbox">
...
export default EmailDialogueChoice;
